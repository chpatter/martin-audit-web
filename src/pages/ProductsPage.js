...
export default function ProductsPage({ initialRecord = '', initialRecordField = 'pono' }) {
    ...
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          {changes.length > 0 && (
            <input placeholder="Filter results... (e.g. prodtype, statustype, priceonty)" value={resultFilter}
