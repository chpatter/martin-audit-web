...
const SOURCE_TABLES = [
  { key: 'ICET', color: '#60a5fa' },
  { key: 'ICSEP', color: '#34d399' },
  { key: 'ICSET', color: '#fbbf24' },
];

const SOURCE_OPTIONS = [
  { value: 'icet', label: 'ICET (Transactions)' },
  { value: 'icsep', label: 'ICSEP (Physical Counts)' },
  { value: 'icset', label: 'ICSET (Count Tickets)' },
];
...
const COLUMNS = [
  ...
  { key: 'field_label', label: 'Inventory Changes', width: 240 },
  { key: 'transproc', label: 'Transaction Process', width: 150 },
  { key: 'new_value', label: 'New Value', width: 190 },
  { key: 'old_value', label: 'Original Value', width: 190 },
...
const CSV_HEADERS = [
  ...
  'Inventory Changes', 'Transaction Process', 'New Value',
    ...
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          {changes.length > 0 && (
            <input placeholder="Filter results... (e.g. transtype, qtycnt, binloc)" value={resultFilter}
