...
const MODULES = [
  ...
  { id: 'products', label: 'Products', icon: '🏷️', active: true, badge: 'PRODUCT CHANGES', description: 'Product master settings', tooltip: 'Queries ICSP — product master settings including descriptions, pricing, status, and UOM.' },
  ...
  { id: 'warehouse', label: 'Warehouse', icon: '🏢', active: true, badge: 'WAREHOUSE CHANGES', description: 'Warehouse product settings — bins, costs, lead times, status', tooltip: 'Queries ICSW — warehouse-level product settings including bin locations, costs, lead times, reorder points, and status.' },
];
