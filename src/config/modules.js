...
const MODULES = [
  ...
  { id: 'products', label: 'Products', icon: '📦', active: true, badge: 'PRODUCT CHANGES', description: 'Product master settings' },
  ...
  { id: 'prod_line', label: 'Prod Line', icon: '📦', active: true, badge: 'PRODUCT LINE CHANGES', description: 'Product line setup — buyers, vendors, ordering' },
